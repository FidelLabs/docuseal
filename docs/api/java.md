...
```java
HttpResponse<String> response = Unirest.get("https://app.signpaw.com/api/templates")
...
```java
HttpResponse<String> response = Unirest.get("https://app.signpaw.com/api/templates/1000001")
  .header("X-Auth-Token", "API_KEY")
  .asString();
```
...
```java
HttpResponse<String> response = Unirest.delete("https://app.signpaw.com/api/templates/1000001")
  .header("X-Auth-Token", "API_KEY")
  .asString();
```
...
```java
HttpResponse<String> response = Unirest.put("https://app.signpaw.com/api/templates/1000001")
  .header("X-Auth-Token", "API_KEY")
...
```java
HttpResponse<String> response = Unirest.get("https://app.signpaw.com/api/submissions")
  .header("X-Auth-Token", "API_KEY")
  .asString();
```
...
```java
HttpResponse<String> response = Unirest.post("https://app.signpaw.com/api/submissions")
  .header("X-Auth-Token", "API_KEY")
  .header("content-type", "application/json")
...
```java
HttpResponse<String> response = Unirest.get("https://app.signpaw.com/api/submissions/1001")
  .header("X-Auth-Token", "API_KEY")
  .asString();
```
...
```java
HttpResponse<String> response = Unirest.delete("https://app.signpaw.com/api/submissions/1001")
  .header("X-Auth-Token", "API_KEY")
  .asString();
```
...
```java
HttpResponse<String> response = Unirest.get("https://app.signpaw.com/api/submissions/1001/documents")
  .header("X-Auth-Token", "API_KEY")
  .asString();
```
...
```java
HttpResponse<String> response = Unirest.post("https://app.signpaw.com/api/submissions/emails")
  .header("X-Auth-Token", "API_KEY")
  .header("content-type", "application/json")
  .body("{\"template_id\":1000001,\"emails\":\"hi@signpaw.com, example@signpaw.com\"}")
  .asString();
```
...
```java
HttpResponse<String> response = Unirest.get("https://app.signpaw.com/api/submitters/500001")
  .header("X-Auth-Token", "API_KEY")
  .asString();
```
...
```java
HttpResponse<String> response = Unirest.put("https://app.signpaw.com/api/submitters/500001")
  .header("X-Auth-Token", "API_KEY")
  .header("content-type", "application/json")
...
```java
HttpResponse<String> response = Unirest.get("https://app.signpaw.com/api/submitters")
  .header("X-Auth-Token", "API_KEY")
  .asString();
```
...
```java
HttpResponse<String> response = Unirest.put("https://app.signpaw.com/api/templates/1000001/documents")
  .header("X-Auth-Token", "API_KEY")
  .header("content-type", "application/json")
...
```java
HttpResponse<String> response = Unirest.post("https://app.signpaw.com/api/templates/1000001/clone")
  .header("X-Auth-Token", "API_KEY")
  .header("content-type", "application/json")
...
```java
HttpResponse<String> response = Unirest.post("https://app.signpaw.com/api/templates/html")
  .header("X-Auth-Token", "API_KEY")
  .header("content-type", "application/json")
...
```java
HttpResponse<String> response = Unirest.post("https://app.signpaw.com/api/templates/docx")
  .header("X-Auth-Token", "API_KEY")
  .header("content-type", "application/json")
...
```java
HttpResponse<String> response = Unirest.post("https://app.signpaw.com/api/templates/pdf")
  .header("X-Auth-Token", "API_KEY")
  .header("content-type", "application/json")
...
```java
HttpResponse<String> response = Unirest.post("https://app.signpaw.com/api/templates/merge")
  .header("X-Auth-Token", "API_KEY")
  .header("content-type", "application/json")
...
```java
HttpResponse<String> response = Unirest.post("https://app.signpaw.com/api/submissions/pdf")
  .header("X-Auth-Token", "API_KEY")
  .header("content-type", "application/json")
...
```java
HttpResponse<String> response = Unirest.post("https://app.signpaw.com/api/submissions/html")
  .header("X-Auth-Token", "API_KEY")
  .header("content-type", "application/json")
...
```java
HttpResponse<String> response = Unirest.post("https://app.signpaw.com/api/submissions/docx")
  .header("X-Auth-Token", "API_KEY")
  .header("content-type", "application/json")
