...
const resp = await fetch("https://app.signpaw.com/api/templates", {
  method: "GET",
  headers: {
...
const resp = await fetch("https://app.signpaw.com/api/templates/1000001", {
  method: "GET",
  headers: {
    "X-Auth-Token": "API_KEY"
  }
...
const resp = await fetch("https://app.signpaw.com/api/submissions", {
  method: "GET",
  headers: {
    "X-Auth-Token": "API_KEY"
  }
...
const resp = await fetch("https://app.signpaw.com/api/submissions/1001", {
  method: "GET",
  headers: {
    "X-Auth-Token": "API_KEY"
  }
...
const resp = await fetch("https://app.signpaw.com/api/submissions/1001/documents", {
  method: "GET",
  headers: {
    "X-Auth-Token": "API_KEY"
  }
...
const resp = await fetch("https://app.signpaw.com/api/submissions/emails", {
  method: "POST",
  headers: {
    "X-Auth-Token": "API_KEY"
  },
  body: JSON.stringify({
    template_id: 1000001,
    emails: "hi@signpaw.com, example@signpaw.com"
  })
});
...
const resp = await fetch("https://app.signpaw.com/api/submitters/500001", {
  method: "GET",
  headers: {
    "X-Auth-Token": "API_KEY"
  }
...
const resp = await fetch("https://app.signpaw.com/api/submitters", {
  method: "GET",
  headers: {
    "X-Auth-Token": "API_KEY"
  }
...
const resp = await fetch("https://app.signpaw.com/api/templates/1000001/documents", {
  method: "PUT",
  headers: {
    "X-Auth-Token": "API_KEY"
  },
...
const resp = await fetch("https://app.signpaw.com/api/templates/1000001/clone", {
  method: "POST",
  headers: {
    "X-Auth-Token": "API_KEY"
  },
...
const resp = await fetch("https://app.signpaw.com/api/templates/html", {
  method: "POST",
  headers: {
    "X-Auth-Token": "API_KEY"
  },
...
const resp = await fetch("https://app.signpaw.com/api/templates/docx", {
  method: "POST",
  headers: {
    "X-Auth-Token": "API_KEY"
  },
...
const resp = await fetch("https://app.signpaw.com/api/templates/pdf", {
  method: "POST",
  headers: {
    "X-Auth-Token": "API_KEY"
  },
...
const resp = await fetch("https://app.signpaw.com/api/templates/merge", {
  method: "POST",
  headers: {
    "X-Auth-Token": "API_KEY"
  },
...
const resp = await fetch("https://app.signpaw.com/api/submissions/pdf", {
  method: "POST",
  headers: {
    "X-Auth-Token": "API_KEY"
  },
...
const resp = await fetch("https://app.signpaw.com/api/submissions/html", {
  method: "POST",
  headers: {
    "X-Auth-Token": "API_KEY"
  },
...
const resp = await fetch("https://app.signpaw.com/api/submissions/docx", {
  method: "POST",
  headers: {
    "X-Auth-Token": "API_KEY"
  },
